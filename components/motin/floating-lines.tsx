...
export default function FloatingLines({
  ...
  const resolvedGradient =
    linesGradient && linesGradient.length
      ? linesGradient
  ...
  useEffect(() => {
    ...
    resolvedGradient.join(","),
    enabledWaves.join(","),
    Array.isArray(lineCount) ? lineCount.join(",") : lineCount,
    Array.isArray(lineDistance) ? lineDistance.join(",") : lineDistance,
    animationSpeed,
    interactive,
    bendRadius,
    bendStrength,
