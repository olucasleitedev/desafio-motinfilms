...
const SERVICES = [
  {
    ...
    body: "Apresente seus produtos, serviços, valores e missão em uma narrativa cinematográfica que posiciona sua marca como referência no mercado.",
  },
  {
    n: "02",
    icon: Package,
    title: "Filmes Produto",
    body: "Destaque seus produtos de maneira única no mercado com direção de arte impecável, iluminação controlada e storytelling focado em conversão.",
  },
  {
    n: "03",
    icon: Calendar,
    title: "Filme Evento Corporativo",
    body: "Capture os momentos mais importantes dos seus eventos e transforme em um aftermovie que emociona, informa e prolonga o impacto da sua marca.",
  },
  {
    n: "04",
    icon: Megaphone,
    title: "Filmes Conteúdo",
    body: "Dê voz à sua marca nas redes sociais com formatos pensados para cada plataforma — verticais, horizontais, curtos e em série.",
  },
];
...
export function Services() {
  return (
    <section
      id="servicos"
      className="relative bg-[#050505] py-24 md:py-36 border-y border-white/5"
    >
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <SectionHeading
          ...
          title={
            <>
              Soluções audiovisuais para{" "}
              <em className="display-italic text-[var(--gold)]">empresas</em>.
            </>
          }
